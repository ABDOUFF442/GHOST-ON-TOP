...
if game.CoreGui:FindFirstChild("SysBroker") then
  game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Welcome!Welcome_Label",Text = "GUI Already loaded, rejoin to re-execute",Duration = 5;})
  return
end
local version = 2
--VARIABLES
...
local function ChangeToggleColor(Button)
  ...
  if led.ImageColor3 == Color3.fromRGB(0, 0, 139) then
    led.ImageColor3 = Color3.fromRGB(0, 0, 139)
  else
...
TitleBarLabel.Text = "____/GHOSTHUB\\___"
...
Home_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
Home_Section_Button.Text = "GHOST/HOME"
...
Game_Section_Button.Text = "GHOST/GAME"
...
Character_Section_Button.Text = "GH.T/CHARACTER"
...
Target_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
Target_Section_Button.Text = "GHOST/TARGET"
...
Animations_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
Animations_Section_Button.Text = "GHOST/ANIMATION"
...
Misc_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
Misc_Section_Button.Text = "GHOST/MICS"
...
AntiRagdoll_Button.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
